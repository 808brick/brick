...
```
<img class="ui massive rounded image" src="/public/images/semanticSave.png">
...
```
<img class="ui massive rounded image" src="/public/images/htmlSaveBlue.png">

However, using Semantic UI, making a blue Save button is way easier:
```HTML
<button class="ui blue button">Save</button>
```
<img class="ui massive rounded image" src="/public/images/semanticSaveBlue.png">
